...
{
    public static class MailContoller
    {
        public static void SendEmail(string attachmentDirectory, List<string> listOfReceipients, string emailAddress, string emailPassword, string clientName, string startDate, string endDate, out bool hasError)
        {
            try
            {
